...
home_games_2020 <- data.frame(matrix(nrow = 33, ncol = 30))
colnames(home_games_2020) <- teams
...
for(x in num){
  ...
  url <- strcat(url, "/2020-schedule-scores.shtml")
  print(url)
  team <- teams[x]
  ...
  #Where we are in the home_games_2020 df
  t <- 1
